...
class GameObject:
    ...
    def __init__(self, x: int = 0, y: int = 0, sprite: Sprite = None):
        self._x : int = x
        self._y : int = y
...
class GameObjectManager:
    ...
    @staticmethod
    def initialize() -> None:
        GameObjectManager.__gameobjects = []

    
    @staticmethod
    def update() -> None:
        for object in GameObjectManager.__gameobjects:
            object.update()
    ...
    def add_object(object : GameObject) -> None:
        GameObjectManager.__gameobjects.append(object)


    @staticmethod
    def remove_object(object : GameObject) -> None:
        GameObjectManager.__gameobjects.remove(object)
    ...
    def get_objects(condition : Callable[[GameObject], tuple[GameObject]]):
        ...
        """
        return tuple(filter(condition, GameObjectManager.__gameobjects))